    ...
    <footer className=' bg-mobile-nav-bg text-white uppercase'>
      <div className='p-5 flex items-center justify-between footer gap-4'>
        ...
        <div className='flex gap-4'>
          <a href='https://facebook.com/prince.duru.355' target='_blank' className='text-2xl bg-[#0a3b52] rounded-full p-2'>
            <BsFacebook className='' />
          </a>
          <a href='https://facebook.com/prince.duru.355' target='_blank' className='text-2xl bg-[#ffcc00] rounded-full p-2'>
            <BsSnapchat />
          </a>
          <a href='https://instagram.com/theprincewillduru' target='_blank' className='text-2xl bg-[#a70f17] rounded-full p-2'>
            <BsInstagram />
          </a>
        </div>
