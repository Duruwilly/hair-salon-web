      ...
      <div className="flex flex-col md:flex-row justify-between gap-10 items-center w-full max-w-screen-lg relative">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-base text-light-gray">
            with the best team in our salon, you'll leave looking astonished.
          </p>
          <Link to="booking" className="mt-6 text-light-gray">
            <span className="bg-mobile-nav-bg pl-2 py-3 capitalize">
              book appoint
            </span>
            <span>ment</span>
          </Link>
        ...
        <div style={HeroBgStyle}>
          ...
          >
            <img
              src={HeroImg}
              alt="female hair service"
              className=" h-3/4 w-2/4 object-cover border rounded-b-full rounded-t-l-full"
            />
          </div>
        </div>
      </div>
